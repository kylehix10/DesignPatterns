...
/**
 * Mouth Class that extends the CharacterDecorator
...
public class Mouth extends CharacterDecorator {
     ...
     * @param character Mouth are a character as well as a decoration
     */
        ArrayList<String> bodyPart = new ArrayList<>();
        bodyPart=FileReader.getLines("txt/mouth.txt");
